...
def run_now():
    ...
    try:
        ...
        return result or "✅ Bot executed successfully! Check Render logs for details."
    except Exception as e:
...
try:
    import scheduler
    logger.info("📅 Планировщик импортирован")
except Exception as e:
    logger.error(f"❌ Ошибка импорта планировщика: {e}")
